...
tables = {
    "accounts": "CREATE TABLE accounts (accNo int primary key AUTO_INCREMENT, name varchar(50), balance decimal(11,2), password varchar(50),secQues varchar(50), secAns varchar(50));",
